...
.draw_background:
	...
	.command_list		db 'Usun plik,Zmien nazwe pliku,Kopiuj plik,Pokaz rozmiar pliku,Pokaz info o dysku,Utworz plik', 0

	.help_msg1		db 'Select a file operation to perform,', 0
	.help_msg2		db 'or press the Esc key to exit...', 0

	.title_msg		db 'MikeOS File Manager mod by Shock', 0
	...
	.filename_tmp1		times 12 db 0
	.filename_tmp2		times 12 db 0

	.create_msg		db 'Enter filename witch extension (np. examaple.txt)'
	.create_input		times 255 db 0
	...
	.tmp_string1		times 12 db 0
	.tmp_string2		times 9 db 0
